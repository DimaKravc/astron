    ...
    <div class="site-spacer__primary site-spacer__primary_no_indents">
                        ...
                        <div class="entry-slider-item__row row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="entry-slider-item__figure">
                                    <img src="<?php echo get_template_directory_uri() . '/images/entry-slide-1--top.png' ?>">
                                    <img src="<?php echo get_template_directory_uri() . '/images/entry-slide-1--bottom.png' ?>">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section-interview angle angle_bottom_left angle_no_indent angle_bg_white">
            <div class="container">
                ...
                <?php
                $content = get_post_field('post_content', get_page_by_title('Interview')->ID);
                        ...
                        <div class="focus-area-slider-item__row row">
                            <div class="col-12 col-lg-6">
                                ...
                                <p class="focus-area-slider-item__text">Worldwide ecommerce sales are expected to make up to 18% of all sales in 2021 with sales volume totaling to almost $5
                                    trillion. Further development of infrastructure, increasing spending power, faster Internet and different Internet plans and cheaper smartphones are going to boost
                                    ecommerce sales all around the world. By 2040 the share of ecommerce of total sales is expected to reach 95%.
                                </p>
                            </div>
                            <div class="col-12 col-lg-6">
                    ...
                    <div class="focus-area-slider-item">
                        <div class="focus-area-slider-item__row row">
                            <div class="col-12 col-lg-6">
                                ...
                                <p class="focus-area-slider-item__text">Food and agriculture value chain is full of inefficiencies and bottlenecks. Farm management is in need to adopt a data-driven
                        ...
                        <div class="focus-area-slider-item__row row">
                            <div class="col-12 col-lg-6">
                                ...
                                <p class="focus-area-slider-item__text">In 2018 global investments in fintech reached $112bn led by several +$10bn megadeals and corporate VC investment in fintech
                                    totaled to $23bn. Majority of banks, insurers and investment managers are expected to partner with fintech over the next 3-5 years. Digital payments are the largest
                        ...
                        <div class="focus-area-slider-item__row row">
                            <div class="col-12 col-lg-6">
                                ...
                                <p class="focus-area-slider-item__text">The global medtech industry is expected to grow at 5.6% per year until 2024, culminating in 2024 global sales of $595bn. The
                                    growth of the market is likely to be driven by increasing adoption of telemedicine, rising incidences of chronic diseases, growing geriatric population, government
            ...
            <div class="container">
                <div class="animation-on-scroll">
                    <h2 class="section-worksteps__title slashed">
                        <span class="slashed__top" title="Worksteps"></span>
                        <span class="slashed__bottom" title="Worksteps"></span>
                    </h2>
                </div>
