    ...
    <div class="container app-form">
        <div class="row">
            <div class="col-12 col-xl-5">
                ...
                <p>
                    <button class="button app-form__offline-toggle" data-target="offline-form">fill out the form offline</button>
                </p>
                <p class="app-form__desc">Venture capital funds are investment funds that manage the money of investors
                ...
                <div data-entry="offline-form" style="display: none;">
                    <div class="app-form-off">
                        <header class="app-form-off__header">
                            <button class="app-form-off__back-link" data-target="online-form">Back to online mode</button>
                        </header>
